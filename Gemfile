...
# Some models need to act as lists
gem 'acts_as_list'
# Use SLIM templates instead of ERBs
gem 'slim-rails'
# User Authentication with Devise
gem 'devise'
# Invite users with devise invitable
...
group :development do
  ...
  # Increase your application's performance by reducing the number of queries it makes. Read more: https://github.com/flyerhzm/bullet
  gem "bullet"
end
