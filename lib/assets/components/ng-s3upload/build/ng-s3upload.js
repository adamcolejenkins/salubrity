...
angular.module('ngS3upload').run(['$templateCache', function($templateCache) {
  ...
  // AJ ADDED 10/8/14
  $templateCache.put('theme/flatdream.html',
    "<div class=\"fileinput fileinput-new\">\n" +
      "<div class=\"fileinput-preview thumbnail\" style=\"width:200px;height:150px;\">\n" +
        "<img ng-src=\"{{ filename }}\" ng-if=\"filename\">\n" +
        "<div class=\"progress\">\n" +
          "<div class=\"progress-bar progress-bar-success\" ng-class=\"{active: uploading}\" role=\"progressbar\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width: {{ progress }}%\" ng-class=\"barClass()\"></div>\n" +
        "</div>\n" +
      "</div>\n" +
      "<div>\n" +
        "<button class=\"btn btn-primary btn-mono-l1 btn-file\" type=\"button\">\n" +
          "<span ng-if=\"!filename\">Select Photo</span>\n" +
          "<span ng-if=\"filename\">Change</span>\n" +
          "<input type=\"file\" name=\"photo\" sytle=\"display:none;\">\n" +
        "</button>\n" +
        "<a href=\"#\" class=\"btn btn-danger\" ng-if=\"filename\">Remove</a>\n" +
      "</div>\n" +
    "</div>"
  );
