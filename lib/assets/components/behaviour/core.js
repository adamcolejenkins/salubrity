...
$(function(){
  ...
  function toggleSideBar(_this){
    ...
    if(w.hasClass("sb-collapsed")){
      ...
      $.cookie('SALUBRITY_sidebar','open',{expires:365, path:'/'});
    }else{
      $(".fa",b).removeClass("fa-angle-left").addClass("fa-angle-right");
      w.addClass("sb-collapsed");
      $.cookie('SALUBRITY_sidebar','closed',{expires:365, path:'/'});
    }
    //updateHeight();
  }
  ...
  if($.cookie('SALUBRITY_sidebar') && $.cookie('SALUBRITY_sidebar') == 'closed'){
