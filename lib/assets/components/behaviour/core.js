...
$(function(){
  ...
  function toggleSideBar(_this){
    ...
    if(w.hasClass("sb-collapsed")){
      ...
      $.cookie('_salubrity_sidebar','open',{expires:365, path:'/'});
    }else{
      $(".fa",b).removeClass("fa-angle-left").addClass("fa-angle-right");
      w.addClass("sb-collapsed");
      $.cookie('_salubrity_sidebar','closed',{expires:365, path:'/'});
    }
    //updateHeight();
  }
  ...
  if($.cookie('_salubrity_sidebar') && $.cookie('_salubrity_sidebar') == 'closed'){
